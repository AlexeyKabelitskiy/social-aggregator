require(['jquery','underscorejs','backbonejs', './aggregator', './utils/wsmultiplexer'
    ...
    aggregator.Router = Backbone.Router.extend({
        ...
        initialize: function () {
            ...
            aggregator.notifications = new aggregator.NotificationsView({collection: new aggregator.Notifications([],this.blockUI), hub: aggregator.shellView});
        },
